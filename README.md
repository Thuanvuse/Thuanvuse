...
<!-- MARQUEE CHỮ CHẠY -->
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Orbitron&weight=600&size=18&duration=1&pause=0&color=F7C600&center=true&vCenter=true&width=1200&lines=🐍+PYTHON+IS+MY+LOVE+🐂+BO+BRINGS+LUCK+✨+CODE+IS+MY+ART+🚀+AI+IS+THE+FUTURE+💻+LEARNING+EVERY+DAY" alt="Marquee 3D" />
</p>
...
<p align="center">
  ...
  <img src="https://media.giphy.com/media/13HgwGsXF0aiGY/giphy.gif" width="120" alt="AI" />
  <img src="https://media.giphy.com/media/3oKIPEqDGUULpEU0aQ/giphy.gif" width="120" alt="Data Science" />
  <img src="https://media.giphy.com/media/26tn33aiTi1jkl6H6/giphy.gif" width="120" alt="Hacker" />
  <img src="https://media.giphy.com/media/ZVik7pBtu9dNS/giphy.gif" width="120" alt="Python Code" />
</p>
...
<div align="center" style="background: rgba(255, 215, 0, 0.05); backdrop-filter: blur(10px); border-radius: 30px; padding: 30px; border: 2px solid rgba(255, 215, 0, 0.3); box-shadow: 0 25px 50px rgba(0,0,0,0.5);">
  ...
  class NguyenTienThuan:
      def __init__(self):
          self.name = "Nguyễn Tiến Thuận"
          self.role = "Python Developer"
          self.skills = ["Python", "AI/ML", "Web Dev", "DevOps"]
          self.motto = "Học tập không ngừng, phát triển không giới hạn!"
          self.dream = "Trở thành một Full-Stack Python Developer giỏi"
          self.hobby = ["Coding", "Đọc sách", "Chơi thể thao", "Khám phá công nghệ mới"]
  
      def intro(self):
          return f"🐂 Xin chào! Mình là {self.name} - đam mê Python và AI!"
